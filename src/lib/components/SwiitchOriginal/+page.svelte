...
<div class="container">
	...
	<div class="round">
		<input type="checkbox" id="onoff" name="onoff" bind:checked={isChecked} />
		<div class="back">
			<label class="but" for="onoff"><span class="on">I</span><span class="off">0</span></label>
		</div>
	</div>
...
*/
	...
	.back {
		...
		border-radius: 105px;
		box-shadow:
			30px 30px 30px -20px rgba(0, 0, 0, 0.3),
			-30px 30px 30px -20px rgba(0, 0, 0, 0.3),
			0 30px 30px 0px rgba(0, 0, 0, 0.3),
			inset 0 -1px 0 0 #333;
	...
	input:checked + .back {
		...
		box-shadow:
			30px 30px 30px -20px rgba(0, 0, 0, 0.1),
			-30px 30px 30px -20px rgba(0, 0, 0, 0.1),
